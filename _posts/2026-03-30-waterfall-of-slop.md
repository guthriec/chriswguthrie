...
Mostly I can intervene before things go very wrong, but a couple times, gaps in testing have led to a feature going off the rails and needing to be restarted. This is the most waterfall-y aspect of my workflow, I think. Small omissions in planning and design, if not caught, can cascade and blow up in later phases. Models still have lack common sense and, like, basic honesty. What I wrote a few months ago absolutely still holds -- models require (really pretty close) supervision by SWEs to produce reliable output.
